...
const App = () => {
  ...
  const { contract: token } = useContract('0x2921882830f334EB190C4c8e994adf88e44bAA5c', 'token');

  const { contract: vote } = useContract("0xB8c673436D0EcA3E29607Fda0479fD6f3c960dce", "vote");
  ...
  useEffect(() => {
    if (!hasClaimedNFT || !editionDrop || !editionDrop.history) {
      return;
    }
  ...
  useEffect(() => {
    if (!hasClaimedNFT || !token || !token.history) {
      return;
    }
  ...
  return (
    <div className="mint-nft">
      <h1>Criou seu NFT? Isso te torna parte da família da nossa DAO. Não é só um membro, você tá com a gente na revolução blockchain</h1>
      <div className="btn-hero">
        <Web3Button
